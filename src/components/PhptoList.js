...
const photos = [
    { id: 'UIUX1', url: UIUX1 },
    { id: 'UIUX2', url: UIUX2 },
    { id: 'FrontEnd1', url: FrontEnd1 },
    { id: 'FrontEnd2', url: FrontEnd2 },
    { id: 'FrontEnd3', url: FrontEnd3 },
    { id: 'FrontEnd4', url: FrontEnd4 },
    { id: 'Sticker1', url: Sticker1 },
    { id: 'Sticker2', url: Sticker2 },
    { id: 'Sticker3', url: Sticker3 },
  ];
